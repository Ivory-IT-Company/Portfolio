...
const Home = () => {
   return (
      <>
         <div className="">
            <div className="flex flex-col justify-center items-center text-center gap-6 max-md:px-2.5 max-h-[600px] max-xl:h-[980px] xl:h-screen ">
               {/* md:px-28 */}
               ...
               <div>
                  <div className="flex flex-row gap-3 text-base max-md:justify-center">
                     <button
                        className="bg-blue-400 rounded-2xl px-10 py-3.5 text-white "
                        type="button">
                        Get Started
                     </button>
                     <button
                        className="rounded-2xl px-10 py-3.5 border border-gray-500 text-gray-600 dark:text-gray-400"
                        onClick={() => {}}
                        type="button">
                        View Services
                     </button>
